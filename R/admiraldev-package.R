...
#'             str_remove str_remove_all str_replace str_replace_all str_trim
#'             str_to_lower str_split str_split_fixed str_subset
#'             str_to_title str_to_upper str_which
...
#' @importFrom tidyr drop_na fill nest pivot_longer pivot_wider unite unnest
